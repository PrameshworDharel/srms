...
if ($filename != "") {
    ...
    $filepath = "N/A";
        ...
        $sql = "INSERT INTO  tblnotice(noticeTitle,noticeDetails,noticeFile) VALUES(:ntitle,:ndetails,:nfile)";
        $query = $dbh->prepare($sql);
        $query->bindParam(':ntitle', $ntitle, PDO::PARAM_STR);
        $query->bindParam(':ndetails', $ndetails, PDO::PARAM_STR);
        $query->bindParam(':nfile', $filepath, PDO::PARAM_STR);
        $query->execute();
                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body">
                                            <form method="post" enctype="multipart/form-data">
                                                ...
                                                <div class="form-group has-success">
                                                    <label for="noticedetails" class="control-label">Notice
                                                        Details</label>
                                                    <div>
