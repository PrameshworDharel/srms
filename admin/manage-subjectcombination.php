                                        ...
                                        <div class="panel">
                                            ...
                                            <div class="panel-body p-20">
                                                <table id="example" class="display table table-striped table-bordered" cellspacing="0" width="100%">
                                                    ...
                                                    <tbody>
                                                        <?php
                                                        $sql = "SELECT tblclasses.ClassName, tblclasses.Semister, tblsubjects.SubjectName, tblsubjectcombination.id as scid
        ...
        JOIN tblsubjects ON tblsubjects.id = tblsubjectcombination.SubjectId";
                                                        ...
                                                        ?>
                                                                <tr>
                                                                    ...
                                                                    <td>
                                                                        <?php echo strtoupper(htmlentities($result->ClassName)); ?>&nbsp;Semester-
                                                                    ...
                                                                    <td>
                                                                        <a href="delete-subjectcombination.php?scid=<?php echo htmlentities($result->scid); ?>" onclick="return confirm('Are you sure you want to delete this subject combination?');">
