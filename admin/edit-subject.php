...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['Update'])) {
        ...
        // Check if the subject code already exists (excluding the current subject)
        $checkQuery = "SELECT * FROM tblsubjects WHERE SubjectCode = :subjectcode AND id != :sid";
        $checkStmt = $dbh->prepare($checkQuery);
        $checkStmt->bindParam(':subjectcode', $subjectcode, PDO::PARAM_STR);
        $checkStmt->bindParam(':sid', $sid, PDO::PARAM_INT);
        $checkStmt->execute();

        if ($checkStmt->rowCount() > 0) {
            $error = "Subject code already exists. Update failed.";
        } else {
            $sql = "UPDATE tblsubjects SET SubjectName = :subjectname, SubjectCode = :subjectcode, CreditHour = :credithour WHERE id = :sid";
                                    ...
                                    <div class="panel-body">
                                        ...
                                        <form class="form-horizontal" method="post">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="subjectname"
                                                        ...
                                                        class="form-control" id="sucess" placeholder="Subject Name"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="text" name="subjectcode" class="form-control"
                                                        ...
                                                        id="success" inputmode="numeric" pattern="[1-9][0-9]{2}"
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" name="credithour" class="form-control"
                                                        value="<?php echo htmlentities($result->CreditHour); ?>"
                                                        id="success" min="1" max="9" placeholder="Credit Hour"
                                                        required="required">
                                                </div>
                                            </div>
