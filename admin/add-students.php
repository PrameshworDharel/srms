...
if (strlen($_SESSION['alogin']) == "") {
    ...
    if (isset($_POST['submit'])) {
        ...
        // Check if roll number already exists for the selected class
        $checkSql = "SELECT * FROM tblstudents WHERE RollId = :roolid AND ClassId = :classid";
        ...
        if ($checkQuery->rowCount() > 0) {
            $error = "Roll number already exists for the selected class";
        } else {
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="number" name="rollid" class="form-control" id="rollid"
                                                        min="1" max="999" required="required" autocomplete="off">
                                                </div>
                                            </div>
                                                ...
                                                <div class="col-sm-10">
                                                    <select name="class" class="form-control" id="class"
                                                        ...
                                                        <option value="<?php echo htmlentities($result->id); ?>">
                                                            <?php echo strtoupper(htmlentities($result->ClassName)); ?>&nbsp;Semester-<?php echo htmlentities($result->Semister); ?>
                                                        </option>
                                                        <?php
                                                                }
                                                            }
                                            ...
                                            <div class="form-group">
                                                ...
                                                <div class="col-sm-10">
                                                    <input type="date" name="dob" class="form-control" id="dob"
                                                        required="required"
                                                        max="<?php echo date('Y-m-d', strtotime('0 day')); ?>">
