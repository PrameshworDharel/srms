                                    ...
                                    <div class="panel">
                                        ...
                                        <div class="panel-body p-20">
                                            ...
                                            <table id="example" class="display table table-striped table-bordered"
                                                ...
                                                <tbody>
                                                    <?php $sql = "SELECT tblstudents.StudentName,tblstudents.RollId,tblstudents.StudentId,tblstudents.Status,tblclasses.ClassName,tblclasses.Semister from tblstudents join tblclasses on tblclasses.id=tblstudents.ClassId";//tblstudents.RegDate,
