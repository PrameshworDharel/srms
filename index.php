...
<body>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                <ul class="navbar-nav ms-auto mb-2 mb-lg-0 gap-5">
                    ...
                    <li class="nav-item shadow rounded"><a class="nav-link active" href="find-result.php">Find Your
                            Result</a>
                    </li>
    ...
    <header class="py-5 bg-image-full" style="background-image: url('images/Birendra.jpg')">
    </header>
    <!-- Content section-->
    ...
    <footer class="py-2 bg-secondary">
        <div class="container">
            <p class="m-0 text-center text-white">Copyright &copy; Birendra Multiple Campus
                <?php echo date('Y'); ?>
            </p>
        </div>
    </footer>
