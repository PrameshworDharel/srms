                    ...
                    <div class="panel login-box">
                        <div class="panel-heading">
                            <div class="panel-title text-center">
                                ...
                                <h5>Birendra Multiple Campus</h5>
                            </div>
                        </div>
                            ...
                            <form action="result.php" method="post">
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="class" class="form-control" id="default" required="required">
                                        ...
                                        <option value="<?php echo htmlentities($result->id); ?>">
                                            ...
                                            Semister-<?php echo htmlentities($result->Semister); ?></option>
                                        <?php }
                                        } ?>
                                    </select>
                                </div>
                                ...
                                <div class="form-group">
                                    ...
                                    <select name="exam" class="form-control" id="exam" required="required">
                                        ...
                                        <?php
                                        $sql = "SELECT DISTINCT Exam FROM tblresult";
                                        $query = $dbh->prepare($sql);
                                        $query->execute();
                                        $results = $query->fetchAll(PDO::FETCH_OBJ);
                                        if ($query->rowCount() > 0) {
                                            foreach ($results as $result) {
                                                echo '<option value="' . htmlentities($result->Exam) . '">';
                                                echo htmlentities($result->Exam);
                                                echo '</option>';
                                            }
                                        }
                                        ?>
                                ...
                                <div class="text-right">
                                    <button type="button" class="btn btn-primary btn-sm "> <a href="index.php">Back to
                                            Home</a></button>
